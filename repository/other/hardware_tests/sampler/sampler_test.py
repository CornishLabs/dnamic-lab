...
class ZotinoSawtooth_StepLocked_FinalPush(EnvExperiment):
    """
    Generate a 0..AMP_V sawtooth on zotino0 and sample it on sampler0,
    ...
    def build(self):
        ...
        self.SAW_FREQ_HZ        = 10.0     # Hz (sawtooth frequency)
        ...
        self.DURATION_S         = 1.0      # total acquisition time
    ...
    def run(self):
        ...
        self.sampler0.init()
        for ch in range(8):
            self.sampler0.set_gain_mu(ch, 0)  # 0 dB
